            ...
            await (async () => {
                ...
                for(let i = 0; i<tokenIds.length;i++){
                    ...
                    res.push({
                        ...
                        inputToken: position.holdToken.toString(),
                        reciveToken: position.collateralToken.toString(),
                        amount: utils.formatEther(position.amount.toString(), {commify: true, pad: true}),
...
<Td isNumeric><BurnFunction tokenId={position.id}/></Td>
</Tr>
